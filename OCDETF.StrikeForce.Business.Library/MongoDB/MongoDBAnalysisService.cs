...
{
    public class MongoDBAnalysisService: MongoDBBaseService, IQtrActivityAnalysisService
    {
        ...
        public MongoDBAnalysisService() { }

        public MongoDBAnalysisService(IQuarterlyActivityService quarterlyActivityService, IStaffingService staffService, ILookupService lookupService, IQuarterReportService quarterReportService)
        {

...
{
    public class AzTableQtrActivityAnalysisService : AzTableBaseService, IQtrActivityAnalysisService
    {
        ...
        public AzTableQtrActivityAnalysisService(IQuarterlyActivityService quarterlyActivityService, IStaffingService staffService, ILookupService lookupService, IQuarterReportService quarterReportService)
        {
